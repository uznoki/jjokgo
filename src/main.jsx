...
function App(){
  ...
  return <div className="app">
    <main>
      <header>
        <b onClick={()=>setV("home")}>쪽<span>GO</span></b>
    ...
    {v!=="auth"&&v!=="guest"&&<nav>
      ...
      <N i={<Users/>} t="함께 읽기방" f={openRooms}/>
      <button className="mic" aria-label="LIVE 독서방 열기" onClick={openRooms}><Mic/></button>
      <N i={<BookOpen/>} t="내 서재"/>
      <N i={<UserRound/>} t="MY 쪽GO" f={()=>setV(accountView)}/>
    </nav>}
  </div>;
}
