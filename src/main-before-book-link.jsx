...
function Room({r,setV}){return <><button className="back" onClick={()=>setV("rooms")}>‹ 돌아가기</button><section className="room"><div className="thumb big">📖</div><div><h2>{r.name} 🔒</h2><b>{r.book_title}</b><p>내가 만든 읽기방</p></div></section><div className="demoNotice">방이 정상적으로 데이터베이스와 연결되었습니다.</div></>} 
